"""
Amadeus Ventures — Text Edition (Agent-Optimized Refactor)
A venture capital simulator ported from the Amadeus Fantasy Console.
Optimized for Large Language Model execution trajectories.
"""
